...
function Scene({ dotColor = '#FFFFFF', bgColor = '#121212', dotOpacity = 0.025 }: SceneProps) {
  ...
  useEffect(() => {
    dotMaterial.uniforms.dotColor.value.setHex(parseInt(dotColor.replace('#', ''), 16))
    dotMaterial.uniforms.bgColor.value.setHex(parseInt(bgColor.replace('#', ''), 16))
